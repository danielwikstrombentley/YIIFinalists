...
- [~] T082 Fix Cesium tileset cleanup during repeated category selection and return-to-idle
  - Meta: Phase PH4 · Feature F001 · Owner `agent:GPT-5.6 Terra (OpenAI)` · Branch `task/001-T082-tileset-reset` · PR — · Blockers —
