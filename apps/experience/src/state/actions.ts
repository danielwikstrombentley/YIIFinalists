...
export const resetToIdle = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context }) => ({
...
export const enterCategoryPreview = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context, event }) => {
    const categoryId =
      event.type === 'category.select' ? event.payload.categoryId : (context.pendingCategoryId ?? context.activeCategoryId);
    return {
...
export const retargetPreview = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ event }) => {
...
export const beginTransitionToProject = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context }) => ({
...
export const enterProjectLanding = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context }) => ({
    activeContentPosition: null,
    activeSequenceId: null,
    activeVoiceoverId: null,
...
export const beginContentPlaying = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context, event }) => {
...
export const requestCategorySwitch = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context, event }) => ({
    pendingCategoryId: event.type === 'category.select' ? event.payload.categoryId : context.pendingCategoryId,
    generation: nextGeneration(context.generation),
  }),
);

export const beginTransitionToPreview = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context }) => ({
    generation: nextGeneration(context.generation),
  }),
);

export const completeTransitionToPreview = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context }) => {
...
export const enterRecovering = assign<ExperienceContext, ExperienceEvent, undefined, ExperienceEvent, never>(
  ({ context, event }) => ({
    lastError: {
      atState: 'unknown',
