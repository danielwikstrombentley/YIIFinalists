...
export function createValidEditorialOption(
  ...
  return {
    ...
    position: 1,
    title: { text: 'Overview', sourceLinks },
    rationale: { text: 'Strong candidate for the overview slot.', sourceLinks },
    sourceLinks,
    draftDisplayText: { text: 'Draft display text.', sourceLinks },
    draftVoiceoverText: { text: 'Draft voiceover script.', sourceLinks },
